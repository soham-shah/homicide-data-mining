...
dataArr = (dataArr.drop(['Record ID', 'Agency Code','Agency Name','Agency Type','City', 'State', 'Year','Incident', 'Crime Type', 'Victim Ethnicity', 'Perpetrator Race', 'Perpetrator Sex', 'Perpetrator Age', 'Perpetrator Ethnicity', 'Relationship','Victim Count','Perpetrator Count', 'Record Source'],axis=1))

# Columns we are working with: Victim Age, Victim Sex, Victim Race, Month, Weapon, Crime Solved
...
x = (dataArr.drop(['Crime Solved'],axis=1))
y = dataArr["Crime Solved"]
