...
# This script prints the statistical analysis for the Victim Age

dataArr = pd.read_csv("../data/database.csv")

# remove these columns
dataArr = (dataArr.drop(['Record ID', 'Agency Code','Agency Name','Agency Type','City', 'State', 'Year','Month', 'Incident', 'Crime Type', 'Crime Solved', 'Victim Sex', 'Victim Race', 'Victim Ethnicity', 'Perpetrator Sex', 'Perpetrator Age', 'Perpetrator Race', 'Perpetrator Ethnicity', 'Relationship','Victim Count','Weapon','Perpetrator Count', 'Record Source'],axis=1))

# remove rows where the victim's age is 0 or above 100
...
plt.savefig('../plots/victimage_1.png')
